...
public class Chapter04 {
    ...
    private boolean purchaseItem(Jedis conn, String buyerId, String itemId, String sellerId, int lprice) {
    ...
    private boolean listItem(Jedis conn, String itemId, String sellerId, double price) {
